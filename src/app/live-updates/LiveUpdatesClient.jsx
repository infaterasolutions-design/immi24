      ...
      <main className="w-full max-w-[1298px] mx-auto px-0 md:px-4 lg:px-24 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
        <section className="col-span-1 lg:col-span-8">
          ...
          <div className="space-y-4 md:space-y-5">
            ...
            {lastUpdated && (
              <div className="text-sm font-bold text-slate-500 mb-6 flex items-center gap-2 uppercase tracking-widest">
                <span className="w-2.5 h-2.5 bg-red-600 rounded-full animate-pulse-red"></span>
