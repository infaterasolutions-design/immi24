...
export default function RecommendedPopup() {
  return (
    <div 
      className="fixed bottom-6 right-6 z-[60] w-[150px] animate-vibrate"
      style={{ height: '46.1px' }}
    >
      <div className="bg-white rounded-md shadow-2xl overflow-hidden border border-slate-200 h-full w-full flex items-center shadow-red-500/10">
